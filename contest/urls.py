...
urlpatterns = patterns('',
                       ...
                       url(r'^get_info', view=get_info, name='home'),
                       url(r'^contest_list/', view=contest_list, name='home'),
                       url(r'^admin', view=login_page, name='home'),
                       url(r'^login_auth', view=login_auth, name='home'),
                       ...
                       url(r'^list/', view=admins_list, name='home'),
                       url(r'^add_new_contest/', view=add_new_contest, name='home'),
                       url(r'^add_contest_info/', view=add_contest_info, name='home'),
                       url(r'^change_contest_status/', view=change_contest_status, name='home'),
                       url(r'^show_images/', view=show_images, name='home'),
                       url(r'^add_admin/', view=add_admin, name='home'),
                       url(r'^add_admin_info/', view=add_admin_info, name='home'),
                       url(r'^change_admin_status/', view=change_admin_status, name='home'),
                       url(r'^upload_photo/', view=upload_photo, name='home'),
